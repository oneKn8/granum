...
**Voiceover:** ElevenLabs neutral US male, ~140 wpm.
...
**Voiceover:**
> Every year, US insurers deny medically necessary care to millions of patients. When a physician appeals, **83%** of those appeals win. But only **10%** are ever filed — because writing one costs twelve hours of physician time, and physicians cost three hundred dollars an hour. **The math kills the appeal before it's ever written.**

**Visual notes:**
- Hold the AMA stat for 4 seconds; this is the policy hook.
...
**Voiceover:**
> Granum's appeal-writer holds a small population of strategies — five to twelve at steady state — one per payer-and-diagnosis pair. A new denial arrives. Three strategies generate three candidate appeals. An LLM-as-judge scores each one against a gold dataset of prior overturned appeals. The winner is submitted. The losers' prompts are **permanently deleted** from the Phoenix registry. No revert. No archive. Apoptosis.
...
**Voiceover:**
> Granum is one agent. There is no supervisor, no meta-watcher, no diagnose-and-patch loop. The agent is the germinal center. It generates, competes, mutates, and prunes. Strategies that lose are permanently deleted — and that constraint forces every mutation to be a real bet. **Apache-2.0. Synthetic data only. Built on Google ADK and Arize Phoenix.**
